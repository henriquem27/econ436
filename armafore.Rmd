...
```{r,echo=FALSE}
fit <- Arima(data1$difbtc,order=c(0,1,11),fixed=c(0,0,NA,0,0,0,0,0,0,0,NA))
fit
...
autoplot(fore2)+autolayer(tsbtc,series = "Data")+autolayer(fore2$mean,series = "forecast")+labs(title= "Forecasting for Bitcoin period 2",subtitle="ARIMA Model with a MA8 and MA15",y="Price")
