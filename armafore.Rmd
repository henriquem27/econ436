...
Looking at the series I have decided to cut data at 2019-09-30, which I did in order to try and split some of the volatility of crypto in between 2 periods, so that it does not 
